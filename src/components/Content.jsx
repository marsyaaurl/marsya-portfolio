    ...
    <>
      ...
      <div className="mt-20 mx-5 p-6 md:p-12 overflow-hidden">
        ...
        <div className="flex flex-row gap-4 overflow-x-auto mt-8 no-scrollbar pl-8 pr-0">
          <img src={StepIn} className="h-32 xs:h-40 md:h-56 object-contain" />
          <img src={Andro} className="h-32 xs:h-40 md:h-56 object-contain" />
          <img src={webPorto} className="h-32 xs:h-40 md:h-56 object-contain" />
          <img src={HIMA} className="h-32 xs:h-40 md:h-56 object-contain" />
        </div>

        <div className="flex flex-row gap-4 overflow-x-auto mt-8 no-scrollbar pl-8 pr-0">
          <img src={pawshop} className="h-32 xs:h-40 md:h-56 object-contain" />
          <img src={Trax} className="h-32 xs:h-40 md:h-56 object-contain" />
          <img src={PKKMB} className="h-32 xs:h-40 md:h-56 object-contain" />
          <img src={Merch} className="h-32 xs:h-40 md:h-56 object-contain" />
        </div>
      </div>
    </>
  );
